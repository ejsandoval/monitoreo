Vue.component('info-bar', {
    ...
    <div id="info_bar">
        <div class="container" v-if="selected != null">
            <div class="selectors">
                <div class="selector"><a v-on:click="select('overall')">Todos</a></div>
                <div class="selector"><a class="selector" v-for="category in categories" v-on:click="select(category.key)">{{category.full}}</a></div>
            </div>
            <h3>{{number}}</h3>
